...
import { GRID_IMAGE_WIDTH, PicsumPhotoDto, toPhoto } from './picsum';
...
export function picsumDtoList(count: number): readonly PicsumPhotoDto[] {
  return Array.from({ length: count }, (_unused, index) =>
    picsumDto({ id: String(index), author: `Author ${index}` }),
  );
}
